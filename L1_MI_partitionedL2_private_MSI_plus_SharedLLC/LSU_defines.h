...
enum LSU_STATE {IDLE, L2CEEXEVT, L2DATA_TO_LLCMEM, DIRINV, DIRACK, DIRCE_TO_LLCMEM,MEMDIRACK, MEML2ACK,LLCACKL2,LLCACKDIR,LLCREQMEM,MEMLLCACK,L2DATA_WB_TO_LLCMEM};
class NoCCommPacket {
public: 
