...
int sc_main (int argc, char * argv[])
{
	...
	cout<<" $$$$$$ " << endl; 
	cout<<pe0.node_internals->npc.l2_miss_count<<endl;
	cout<<pe1.node_internals->npc.l2_miss_count<<endl;
	cout<<pe2.node_internals->npc.l2_miss_count<<endl;
	cout<<pe3.node_internals->npc.l2_miss_count<<endl;
	cout<<pe4.node_internals->npc.l2_miss_count<<endl;
	cout<<pe5.node_internals->npc.l2_miss_count<<endl;
	cout<<pe6.node_internals->npc.l2_miss_count<<endl;
	cout<<pe7.node_internals->npc.l2_miss_count<<endl;
	cout<<pe8.node_internals->npc.l2_miss_count<<endl;
	cout<<pe9.node_internals->npc.l2_miss_count<<endl;
	cout<<pe10.node_internals->npc.l2_miss_count<<endl;
	cout<<pe11.node_internals->npc.l2_miss_count<<endl;
	cout<<pe12.node_internals->npc.l2_miss_count<<endl;
	cout<<pe13.node_internals->npc.l2_miss_count<<endl;
	cout<<pe14.node_internals->npc.l2_miss_count<<endl;
	cout<<" $$$$$$ " << endl; 
	cout<<pe0.node_internals->npc.l2_hit_count<<endl;
	cout<<pe1.node_internals->npc.l2_hit_count<<endl;
	cout<<pe2.node_internals->npc.l2_hit_count<<endl;
	cout<<pe3.node_internals->npc.l2_hit_count<<endl;
	cout<<pe4.node_internals->npc.l2_hit_count<<endl;
	cout<<pe5.node_internals->npc.l2_hit_count<<endl;
	cout<<pe6.node_internals->npc.l2_hit_count<<endl;
	cout<<pe7.node_internals->npc.l2_hit_count<<endl;
	cout<<pe8.node_internals->npc.l2_hit_count<<endl;
	cout<<pe9.node_internals->npc.l2_hit_count<<endl;
	cout<<pe10.node_internals->npc.l2_hit_count<<endl;
	cout<<pe11.node_internals->npc.l2_hit_count<<endl;
	cout<<pe12.node_internals->npc.l2_hit_count<<endl;
	cout<<pe13.node_internals->npc.l2_hit_count<<endl;
	cout<<pe14.node_internals->npc.l2_hit_count<<endl;
	cout<<" $$$$$$ " << endl; 
	cout<<pe0.node_internals->llc.llc_miss_count<<endl;
	cout<<pe1.node_internals->llc.llc_miss_count<<endl;
	cout<<pe2.node_internals->llc.llc_miss_count<<endl;
	cout<<pe3.node_internals->llc.llc_miss_count<<endl;
	cout<<pe4.node_internals->llc.llc_miss_count<<endl;
	cout<<pe5.node_internals->llc.llc_miss_count<<endl;
	cout<<pe6.node_internals->llc.llc_miss_count<<endl;
	cout<<pe7.node_internals->llc.llc_miss_count<<endl;
	cout<<pe8.node_internals->llc.llc_miss_count<<endl;
	cout<<pe9.node_internals->llc.llc_miss_count<<endl;
	cout<<pe10.node_internals->llc.llc_miss_count<<endl;
	cout<<pe11.node_internals->llc.llc_miss_count<<endl;
	cout<<pe12.node_internals->llc.llc_miss_count<<endl;
	cout<<pe13.node_internals->llc.llc_miss_count<<endl;
	cout<<pe14.node_internals->llc.llc_miss_count<<endl;
	cout<<" $$$$$$ " << endl; 
	cout<<pe0.node_internals->llc.llc_hit_count<<endl;
	cout<<pe1.node_internals->llc.llc_hit_count<<endl;
	cout<<pe2.node_internals->llc.llc_hit_count<<endl;
	cout<<pe3.node_internals->llc.llc_hit_count<<endl;
	cout<<pe4.node_internals->llc.llc_hit_count<<endl;
	cout<<pe5.node_internals->llc.llc_hit_count<<endl;
	cout<<pe6.node_internals->llc.llc_hit_count<<endl;
	cout<<pe7.node_internals->llc.llc_hit_count<<endl;
	cout<<pe8.node_internals->llc.llc_hit_count<<endl;
	cout<<pe9.node_internals->llc.llc_hit_count<<endl;
	cout<<pe10.node_internals->llc.llc_hit_count<<endl;
	cout<<pe11.node_internals->llc.llc_hit_count<<endl;
	cout<<pe12.node_internals->llc.llc_hit_count<<endl;
	cout<<pe13.node_internals->llc.llc_hit_count<<endl;
	cout<<pe14.node_internals->llc.llc_hit_count<<endl;
	cout<<" $$$$$$ " << endl;
	cout<<pe15.memnode_internals->ram.mem_access_count_rd<<endl;
	cout<<" $$$$$$ " << endl;
	cout<<(pe15.memnode_internals->ram.mem_access_count_wr + pe15.memnode_internals->ram.mem_access_count_rd) <<endl;
	cout<<" $$$$$$Simulation_Results$$$$$$"<<endl;
//	sc_start();
	return 0;
}
